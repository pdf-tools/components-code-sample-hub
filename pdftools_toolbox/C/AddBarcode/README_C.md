...
This kit contains the AddBarcode sample for the PdfTools SDK for C. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
Use CMake to generate a make file which in turn can be used to compile the sample `toolboxaddbarcode`.
...
4. execute sample: `./toolboxaddbarcode <inputPath> <barcode> <fontfile> <outputPath>`
