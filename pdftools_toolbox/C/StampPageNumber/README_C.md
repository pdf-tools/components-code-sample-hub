...
Use CMake to generate a make file which in turn can be used to compile the sample `toolboxstamppagenumber`.
...
4. execute sample: `./toolboxstamppagenumber <inputPath> <outputPath>`
