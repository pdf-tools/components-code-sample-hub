...
Use CMake to generate a make file which in turn can be used to compile the sample `toolboxlistsignatures`.
...
4. execute sample: `./toolboxlistsignatures <inputPath>`
