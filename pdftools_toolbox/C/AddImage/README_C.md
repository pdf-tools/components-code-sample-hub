...
This kit contains the AddImage sample for the PdfTools SDK for C. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
Use CMake to generate a make file which in turn can be used to compile the sample `toolboxaddimage`.
...
4. execute sample: `./toolboxaddimage <inputPath> <imagePath> <pageNumber> <outputPath>`
