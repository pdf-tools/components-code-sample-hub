...
Use CMake to generate a make file which in turn can be used to compile the sample `toolboxaddvectorgraphics`.
...
4. execute sample: `./toolboxaddvectorgraphics <inputPath> <outputPath>`
