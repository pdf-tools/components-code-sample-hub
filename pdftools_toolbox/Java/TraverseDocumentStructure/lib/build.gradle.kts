...
dependencies {
    ...
    if (osClassifier == "windows-x86_64") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:win-x64@dll")
    } else if (osClassifier == "windows-x86") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:win-x86@dll")
    } else if (osClassifier == "windows-arm64") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:win-arm64@dll")
    } else if (osClassifier == "linux-x86_64") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:linux-x64@so")
    } else if (osClassifier == "linux-x86_64-glibc2.12") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:linux-x64-glibc2.12@so")
    } else if (osClassifier == "linux-arm64") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:linux-arm64@so")
    } else if (osClassifier == "osx-x86_64") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:osx-x64@dylib")
    } else if (osClassifier == "osx-arm64") {
        runtimeOnly("com.pdftools:toolbox:1.11.1:osx-arm64@dylib")
    } else {
