...
This kit contains the ListSignatures sample for the PdfTools SDK for C#. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
1. Execute in sample folder:
    `dotnet run --framework net8.0 --project ToolboxListSignatures.csproj <inputPath>`

**Via Visual Studio:**

1. At least Visual Studio 2022 installed
2. Double click on `ToolboxListSignatures.csproj`
3. Compile project in Visual Studio
4. Run:
    `ToolboxListSignatures.exe <inputPath>`
