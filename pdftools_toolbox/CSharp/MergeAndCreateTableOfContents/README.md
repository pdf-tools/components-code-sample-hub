...
This kit contains the MergeAndCreateTableOfContents sample for the PdfTools SDK for C#. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
2. Double click on `ToolboxMergeAndCreateTableOfContents.csproj`
