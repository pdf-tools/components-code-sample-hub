...
Use CMake to generate a make file which in turn can be used to compile the sample `pdftoolsmerge`.
...
4. execute sample: `./pdftoolsmerge <inputPath> [<inputPath2> ...] <outputPath>`
