...
This kit contains the FlattenAnnotations sample for the Pdftools SDK for C. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
Use CMake to generate a make file which in turn can be used to compile the sample `pdftoolsflattenannotations`.
...
4. execute sample: `./pdftoolsflattenannotations <inputPath> <outputPath>`
