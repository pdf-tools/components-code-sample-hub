...
Use CMake to generate a make file which in turn can be used to compile the sample `pdftoolsmultipleimg2pdf`.
...
4. execute sample: `./pdftoolsmultipleimg2pdf <inputPath> [<inputPath2> ...] <outputPath>`
