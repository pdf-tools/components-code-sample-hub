...
Use CMake to generate a make file which in turn can be used to compile the sample `pdftoolsimg2pdfdefault`.
...
4. execute sample: `./pdftoolsimg2pdfdefault <inputPath> <outputPath>`
