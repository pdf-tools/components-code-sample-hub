...
This kit contains the ValidateConvert sample for the Pdftools SDK for VB. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
2. Double click on `PdfToolsValidateConvert.vbproj`
