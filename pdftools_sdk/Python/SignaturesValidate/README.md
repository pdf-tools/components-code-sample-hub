...
This kit contains the SignaturesValidate sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./signatures_validate.py <input_path> [<certificate_directory>]
```

To get help, run the following command:

```bash
python ./signatures_validate.py -h
```
