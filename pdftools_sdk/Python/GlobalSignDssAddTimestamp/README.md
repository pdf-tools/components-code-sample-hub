...
This kit contains the GlobalSignDssAddTimestamp sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./global_sign_dss_add_timestamp.py <input_path> <output_path>
```

To get help, run the following command:

```bash
python ./global_sign_dss_add_timestamp.py -h
```
