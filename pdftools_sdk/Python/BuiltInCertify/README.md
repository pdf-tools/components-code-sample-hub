...
This kit contains the BuiltInCertify sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./built_in_certify.py <certificate_file> <password> <input_path> <output_path>
```

To get help, run the following command:

```bash
python ./built_in_certify.py -h
```
