...
This kit contains the Img2PdfAccessibility sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./img2_pdf_accessibility.py <input_path> <alternate_text> <output_path>
```

To get help, run the following command:

```bash
python ./img2_pdf_accessibility.py -h
```
