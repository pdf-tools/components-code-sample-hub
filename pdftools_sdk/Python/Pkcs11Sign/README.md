...
This kit contains the Pkcs11Sign sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./pkcs11_sign.py <pkcs11_library> <password> <certificate> <input_path> <output_path>
```

To get help, run the following command:

```bash
python ./pkcs11_sign.py -h
```
