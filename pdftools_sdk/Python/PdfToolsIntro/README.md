...
This kit contains the PdfToolsIntro sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./pdf_tools_intro.py <cover_image> <content_pdf_path> <output_path>
```

To get help, run the following command:

```bash
python ./pdf_tools_intro.py -h
```
