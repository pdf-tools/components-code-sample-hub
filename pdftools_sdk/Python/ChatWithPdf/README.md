...
This kit contains the ChatWithPdf sample for the Pdftools SDK for Python. The Pdftools SDK is a comprehensive development library that lets developers integrate advanced PDF functionalities into in-house applications. Find more information about this kit in Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
```bash
python ./chat_with_pdf.py <input_path> <question>
```

To get help, run the following command:

```bash
python ./chat_with_pdf.py -h
```
